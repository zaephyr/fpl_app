export default {
  ...
  onActiveLeagueChange({ commit }, { activeLeague }) {
    commit('SET_ACTIVE_LEAGUE', { activeLeague })
    commit('SET_STANDINGS', null)
    commit('SET_SQUADS', null)
  },
  addStandings({ commit }, standings) {
    commit('SET_STANDINGS', standings)
  },
  addSquads({ commit }, squads) {
    commit('SET_SQUADS', squads)
  },
  addActiveLeague({ commit }, activeLeague) {
    commit('SET_ACTIVE_LEAGUE', activeLeague)
  },
}
